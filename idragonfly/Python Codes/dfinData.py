...
from dfndData import dfndData

def dfinData(l_, phiT_, phiB_, c_, x_, y_,
             a_, b_, f_, beta_, delta_, gMax_,
             p, rtOff, U_, V_):
    """
    INPUT VARIABLES
    ...
    * rT        ratio of two periods (front/rear)
    ...
    v_, t_, d_, e, c, x, y, a, b, U, V = dfndData(l_, phiT, phiB, c_, x_, y_, a_, b_, U_, V_, T_)

    return rT, v_, t_, d_, d, e, c, x, y, a, b, beta, delta, gMax, U, V